...
import com.nexterp.myapplication.camera.CameraPreview;
import com.nexterp.myapplication.camera.CameraUtil;
import com.nexterp.myapplication.cropcontrol.CropController;
...
public class CameraFragment extends Fragment {
    ...
    public static final String PACKAGE_NAME = "com.nexterp.myapplication";
    ...
    private void loadLocalContent() {
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                final String js = "javascript:setLatex('" + recognizedText + "')";
                if (mWebView != null) {
                    mWebView.loadUrl(js);
                }
            }
